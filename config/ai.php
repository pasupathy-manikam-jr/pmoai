...
return [
    ...
    // --- LLM provider: groq (free, testing) | openai (paid) | anthropic (paid, web search) ---
    'llm_provider' => env('LLM_PROVIDER', 'groq'),

    // --- Groq (OpenAI-compatible, free tier, no web search) ---
    ...
    //     subscription, no API credits; analyzeFund only, rest → Groq) ---
